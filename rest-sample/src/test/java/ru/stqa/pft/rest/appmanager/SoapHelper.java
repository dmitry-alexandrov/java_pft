...
public class SoapHelper {
  ...
  public ObjectRef[] getStates() throws MalformedURLException, ServiceException, RemoteException {
    MantisConnectPortType mc = getMantisConnect();
    ObjectRef[] states = mc.mc_enum_status("administrator", "root");
 ...
 //   return mc;
    MantisConnectPortType mc = new MantisConnectLocator()
               .getMantisConnectPort(new URL(app.getProperty("web.baseUr") + "api/soap/mantisconnect.php"));
       return mc;
  }
